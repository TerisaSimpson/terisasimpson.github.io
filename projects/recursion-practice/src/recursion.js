...
var factorial = function(n) {
  if (n < 0){ //base case; if n is less than 0
    return null //return null
  } else if (n === 0){ //base case;if n is equal to 0
    return 1 //return 1
  } else {
...
// https://www.khanacademy.org/computing/computer-science/algorithms/recursive-algorithms/a/computing-powers-of-a-number
  ...
  if(exp === 0) { //base case
    return 1; //number raised to the exponent of 0 or a negative number; return 1
  } else if (exp === 1) { //base case 
    return base; //returns base when exp equals 1
  } else if (exp < 0) { //recursion case for negative numbers
    return 1 / (base * exponent(base, (exp * -1 - 1)));
  }
  return base * exponent(base, exp - 1);//recursion case for positive integer exponents
...
var capitalizeFirst = function(array) {
  if (array[0].toUpperCase){
    return []
  }
  return array[0] + capitalizeFirst(array.slice(1))
};
